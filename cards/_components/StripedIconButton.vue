...
.striped-button {
  ...
  @each $vote, $color in $proper-vote-colors {
    &.#{$vote} {
      ...
      &.is-hovered:not(.is-disabled) {
        background: map-get($proper-vote-colors-hover, $vote);
      }
    }
  }
  ...
  @each $party, $color in $party-colors {
    &.#{$party} {
      ...
      &.is-hovered:not(.is-disabled) {
        background: map-get($party-colors-hover, $party);
      }
    }
  }
