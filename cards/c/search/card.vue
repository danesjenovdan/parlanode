...
export default {
  ...
  created() {
    // $.get(`${this.slugs.urls.analize}/p/getListOfMembersTickers/${this.data.session.id}?page=${newPage}`, (response) => {
    ...
    //       });
    //     });
    // console.log(this.grouped, this.groups, this.people, this.parties);
  },
  computed: {
    allItems() {
