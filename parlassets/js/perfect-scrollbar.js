...
function Instance(element) {
  ...
  // + 10 at the end because the scrollbar is margin-top 10px so it looks better. JP
  i.railYMarginHeight = h.toInt(d.css(i.scrollbarYRail, 'marginTop')) + h.toInt(d.css(i.scrollbarYRail, 'marginBottom')) + 10;
